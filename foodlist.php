...
<html>
  ...
  <head>
    <title> Explore | Food Fra'ly </title>
  </head>
...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="logout_m.php" onmouseover="this.style.backgroundColor='black' " onmouseout="this.style.backgroundColor='#6b5b95'"><span class="#"></span> Log Out </a></li>
          </ul>
<?php
}
...
?>
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
      <img src="images/pizza1.jpg" style="width:100%; height:70%">
      <div class="carousel-caption">
      </div>
      </div>
...
<!-- <div class="jumbotron"> -->
  ...
  <div class="container text-center">
    <b><h1 style="color:#6b5b95; text-shadow: 2px 2px 5px #6b5b95; font-size:90">Welcome To Fra'ly</h1>  </b>    
    <!--p>Let food be thy medicine and medicine be thy food</p--> <br><br><br>
  </div>
</div>
...
<h5 class="text-info" style="color:#6b5b95"><?php echo $row["description"]; ?></h5>
<h5 class="text-danger">&#8377; <?php echo $row["price"]; ?>/-</h5>
<h5 class="text-info">Quantity: <input type="number" min="1" max="25" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>
<input type="hidden" name="hidden_name" value="<?php echo $row["name"]; ?>">
<input type="hidden" name="hidden_price" value="<?php echo $row["price"]; ?>">
<input type="hidden" name="hidden_RID" value="<?php echo $row["R_ID"]; ?>">
<input type="submit" name="add" style="margin-top:5px; background-color:#6b5b95" class="btn btn-success" value="Add to Cart">
</div>
</form>
