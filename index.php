      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar" style="background-color: #6b5b95; ";>
          <ul class="nav navbar-nav">
            <li class="active"  ><a href="index.php" style="background-color: black; color:white" onmouseover="this.style.backgroundColor='grey'" onmouseout="this.style.backgroundColor='black'">Home</a></li>
...
<?php
  ...
  ?>
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"  style="background-color:'#6b5b95' ;color: white"><a href="foodlist.php" onmouseover="this.style.backgroundColor=black"  onmouseout="this.style.backgroundColor='#6b5b95'" ><span class="#"></span> Food Zone </a></li>
...
?>
    ...
    <div class="wide" style="background-image: url('https://wallpapercave.com/wp/wp1874157.jpg');height:558px ; position:relative;">
      	<div class="col-xs-5 line"><hr></div>
        <div class="col-xs-2 logo"><img src="images/LogoImage.jpg"></div>
        <div class="col-xs-5 line"><hr></div> <br>
        <div class="tagline" style="font-size:40px; color: white;"><br><br> All hapiness depends on a leisurely meal<br> <br> 
        <center><a class="btn btn-success btn-lg" href="customerlogin.php" role="button" style="background-color: #6b5b95; background-image: none" onmouseover="this.style.backgroundColor='#878f99'" onmouseout="this.style.backgroundColor='#6b5b95'">  Order Now </a></center>
    </div>
    <!-- </div> -->
