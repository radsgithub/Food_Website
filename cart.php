...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="foodlist.php" style="color: white;" onmouseover="this.style.backgroundColor='#d64161'" onmouseout="this.style.backgroundColor='#6b5b95'"><span class="#"></span> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            <li class="active"  ><a href="foodlist.php" style="background-color: #6b5b95; color:white" onmouseover="this.style.backgroundColor='black'" onmouseout="this.style.backgroundColor='#6b5b95'">Food Zone</a></li>
            <li><a href="cart.php" style="color: white;background-color:black" onmouseover="this.style.backgroundColor='grey' " onmouseout="this.style.backgroundColor='black'"><span class=""></span> Cart  (<?php
...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container" style="color: white;">
      <!-- <div class="jumbotron"> -->
       <center> <h1>Your Shopping Cart</h1>
        <p>Looks tasty...!!!</p>
        </center>
      </div>
      
    </div> <br><br>
    <div class="table-responsive" style="padding-left: 100px; padding-right: 100px; color:white" >
...
<td><a href="cart.php?action=delete&id=<?php echo $values["food_id"]; ?>"><span class="text-danger" style="color: red;"><b></b> Remove</span></a></td>
</tr>
<?php 
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="#"></span> Empty Cart</button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Check Out</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ?>
  <div class="container">
      <!-- <div class="jumbotron"> --> <br><br><br> <center style="color: white;">
        <h1>Your Shopping Cart</h1>
        <p><h2>Oops! We can't smell any food here. Go back and <a href="foodlist.php"><b> order now.</a></p></center>
        </h2></b>
      </div>
